# حالة التسليم — M0/M1
تحديث 2026-09-24: بدأ M2 بتكليف المالك. اكتملت محليًا شريحة مصروف جزئي/غير مدفوع وتسويات متعددة مؤرخة؛ التفاصيل والاختبارات في [M2_EXPENSE_SETTLEMENTS](evidence/M2_EXPENSE_SETTLEMENTS.md). M2 بكاملها وV1 غير مكتملتين. التعديلات السابقة غير الملتزم بها في `AGENTS.md` و`.codex/` تخص سياسة الاستهلاك وحُفظت دون تغيير في هذه المهمة. لم يُستخدم وكيل فرعي.
