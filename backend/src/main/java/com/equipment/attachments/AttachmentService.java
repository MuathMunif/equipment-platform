...
public class AttachmentService {
    private final JdbcTemplate db; private final Access access; private final FinanceService finance; private final DocumentService documents; private final MaintenanceService maintenance; private final Idempotency retries; private final Audit audit; private final ObjectStorageService storage; private final ContentValidator validator;
    public AttachmentService(JdbcTemplate db,Access access,FinanceService finance,DocumentService documents,MaintenanceService maintenance,Idempotency retries,Audit audit,ObjectStorageService storage,ContentValidator validator) { this.db=db;this.access=access;this.finance=finance;this.documents=documents;this.maintenance=maintenance;this.retries=retries;this.audit=audit;this.storage=storage;this.validator=validator; }
