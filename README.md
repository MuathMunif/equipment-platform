...
تطبيق Flutter عربي RTL وباك إند Spring Boot وPostgreSQL فعلي. اكتملت M0/M1 محليًا ونُفذت أربع شرائح من M2؛ بقية M2 وV1 غير مكتملتين، ولا يوجد إعداد إنتاج.
...
أعد تشغيل API بعد تحديث الكود حتى يستخدم ترحيلات Flyway V1–V5؛ بقاء عملية قديمة على 8080 لا يثبت أنها تشغّل آخر commit.
...
آخر تشغيل لهذه الشريحة: 13 اختبار Flutter ناجحًا. تشمل المدخلات العربية الدقيقة، العرضين الضيق والواسع، الاسم المطلوب، مهلة HTTP كاملة، بقاء مفتاح الحفظ بعد فقد الرد، نماذج المصروف والإيراد والاسترداد، عرض تاريخ الاسترداد والصافي، تعديل العملية، تأكيد الإلغاء وعرض الحالة الملغاة، واستبدال مرفق مرفوض دون إنشاء عملية مالية جديدة. اختبارات widget تستخدم HTTP doubles ولا يُقدَّم نجاحها كدليل تكامل فعلي؛ اختبارات iOS وفحوص الويب الحية السابقة موثقة في HANDOFF والأدلة.
